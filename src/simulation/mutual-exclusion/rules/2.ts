...
class SimulationModel extends Model<ModelEvents> {
    ...
    queueMessage() {
        this.process.addPending(new MessageModel(5, "b", "request"));
    }
...
const view = new SimulationView(model, {
    canvasId: "mutual-exclusion-condition-2-simulation",
    controlsId: "mutual-exclusion-condition-2-simulation-controls",
});
